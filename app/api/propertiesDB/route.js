...
// GET request to fetch all properties or a specific property by ID
export async function GET(request) {
  ...
  // If an ID is provided, fetch that specific property
  if (id) {
  ...
  // If no ID is provided, fetch all properties
